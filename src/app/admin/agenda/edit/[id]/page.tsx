...
export default function EditAgenda() {
  ...
  if (fetching) {
    return <div className="p-10 text-center text-slate-500 italic">Memuat data agenda...</div>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900">Edit Agenda</h1>
          <p className="text-slate-500 mt-1">Perbarui informasi jadwal kegiatan pimpinan.</p>
        </div>
      </div>
