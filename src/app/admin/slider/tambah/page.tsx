...
export default function TambahSlider() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!file) {
      alert('Silakan pilih gambar background (Image URL) terlebih dahulu.');
      return;
    }
  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Tambah Slide Baru</h1>
      </div>

      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-2">Background Image <span className="text-red-500">*</span></label>
          {preview && (
            <div className="mb-4">
